...
def get_stats(fgevents, bgevents, injparams, duration=None,
  ...
  #  if found_injections.shape[0] == 0 or found_injections.shape[1] <= 1:
    #    print("Warning: found_injections array is empty or has insufficient columns.")
     #   print(f"found_injections shape: {found_injections.shape}")
     #   print(found_injections)
    #    return None   
...
def main(doc):
   ...
   # if stats is None:
     #   print(f"Skipping evaluation for {args.foreground_events} due to insufficient data.")
     #   return   
    # Store results
